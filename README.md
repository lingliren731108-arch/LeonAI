...
Leon AI is a lightweight, multi-user development platform designed to facilitate user development, based on the Claude Code CLI development tool. It integrates a React-based front-end workspace with a FastAPI back-end, supporting real-time AI assistance, code editing, previewing, and workspace terminal execution.
